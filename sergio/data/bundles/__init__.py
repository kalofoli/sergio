...
from .entities import EntityAttributes, EntityAttributesWithTarget
from .structures import EntityAttributesWithStructures
...
if False:
    ...
    from sergio.attributes import AttributeKind, AttributeFactory
    ...
    class EntitiesWithStructures(Summarisable):
        ...
        @classmethod
        def _infer_attribute_kind(cls, series: Series, hint=None):
            kind : AttributeKind
            if hint is None:
